...
mod tests {
    ...
    fn test_thread1_response_leaks_to_thread2() {
        ...
        app.thread_messages.push(thread1_id, crate::thread::Message::user(user_input_t1.to_string()));
        ...
        app.thread_messages.push(thread2_id, crate::thread::Message::user(user_input_t2.to_string()));
        ...
        app.thread_messages.push(thread1_id, crate::thread::Message::user(ai_response_t1.to_string()));
    ...
    fn test_thread_event_send_timing_issue() {
        ...
        // 记录用户输入时的活动线程 ID
        let active_at_input_time = app.thread_store.active_thread().map(|t| t.id).unwrap();

        app.thread_messages.push(thread1_id, crate::thread::Message::user("Question".to_string()));
    ...
    fn test_real_world_cross_talk_scenario() {
        ...
        app.thread_messages.push(thread1_id, crate::thread::Message::user(user_input.to_string()));
        ...
        app.thread_messages.push(thread2_id, crate::thread::Message::user(user_input2.to_string()));
        ...
        app.thread_messages.push(thread2_id, crate::thread::Message::user(ai_response_t2.to_string()));
